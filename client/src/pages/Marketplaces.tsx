...
export default function Marketplaces() {
  ...
  // Function to render exchange listings
  const renderExchangeListings = () => {
    if (isLoading) return <p>Loading exchange listings...</p>;
    if (error) return <p className="text-red-500">Error loading exchange listings</p>;
    
    if (exchangeListings.length === 0) {
      return (
    ...
    return exchangeListings.map((listing: any) => (
  ...
  // Function to render NFT collections
  const renderNftCollections = () => {
    if (isLoading) return <p>Loading NFT collections...</p>;
    if (error) return <p className="text-red-500">Error loading NFT collections</p>;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-amber-950/30 to-black text-white">
      {/* Marketplace Header - Unique amber/gold style */}
      <div className="bg-gradient-to-r from-amber-900 to-orange-900 shadow-lg border-b border-amber-500/30">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center md:justify-between">            
            <div>
              <h1 className="text-3xl font-bold tracking-tight flex items-center">
                <TrendingUp className="mr-2 h-8 w-8 text-amber-400" />
            ...
            <div className="mt-4 md:mt-0">
              <Button variant="outline" className="bg-black/40 border-amber-500/50 text-amber-400 hover:bg-amber-500/20">
